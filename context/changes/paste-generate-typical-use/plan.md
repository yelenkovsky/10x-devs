...
- [ ] 3.4 Empty paste shows explanatory empty-state; the screen does not freeze
- [ ] 3.5 Generate shows the progress panel (status + elapsed) until the batch appears
- [ ] 3.6 Cards show all six fields; refresh still shows them
- [ ] 3.7 A second generate accumulates; a 20-item list shows 15 cards plus the first-15 note
- [ ] 3.8 Typical-use spot-check: one word-list paste and one short-paragraph paste — cards teach context, collocation, and grammar pattern, not C1/C2 showpieces
- [ ] 3.9 Signed in as user B, none of user A’s cards (or paste) appear
