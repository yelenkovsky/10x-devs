...
Situations where cards are made with someone else (teacher, partner, class) — coordination overhead exists, but the primary actor is still the self-learner. Not MVP-defining.
...
- Building a custom advanced spaced-repetition algorithm — MVP uses a ready-made algorithm only.
